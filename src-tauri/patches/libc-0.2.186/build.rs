...
/// is used instead.
fn rustc_version_cmd(_is_clippy_driver: bool) -> Output {
    // Patched for TRAE sandbox: unreachable, rustc_minor_nightly is hardcoded.
    panic!("rustc_version_cmd should not be called in patched build");
}
...
fn which_freebsd() -> Option<i32> {
    // Patched for TRAE sandbox: do not spawn a process.
    None
}
